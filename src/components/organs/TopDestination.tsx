...
import City7 from "../../assets/gallery7.jpg"
                ...
                <Slider ref={(slider) => (sliderRef.current = slider)} {...settings}>
                    {
                        TopDestinationTexts.cards.map((card, index) => (
                            <div key={index} className="md:px-6 px-3">
                                <Link href='/BookingTour' variant="body2" sx={{ textDecoration: 'none' }}>
                                <Card cardClass="overflow-hidden shadow-md rounded-lg cursor-pointer group" 
                                    imageAlt={card.country} imageSrc={renderCities(index)} 
                                    ...
                                    <div className="w-full flex gap-4 items-center text-color3">
                                        ...
                                        <Text as="span" className=" text-color3 font-light text-base">
                                            {card.duration}
                                        </Text>
                                    </div>
                                </Card>
